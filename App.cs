...
app.UseCors(corsBuilder => corsBuilder.WithOrigins("http://localhost:5173", "http://localhost:5174", "http://192.168.0.104:5173", "http://localhost", "http://159.223.15.127").AllowAnyHeader().AllowAnyMethod().AllowCredentials());
